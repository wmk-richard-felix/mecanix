	...
	<body>
		@include('shared.simple-header')
			<div class="container-fluid">
				<div class="row">
					<div class="login-img-container col-6 d-none d-md-block d-lg-block d-xl-block px-0">
						<img class="login-img" src="{{url('/')}}/images/car-mechanic-and-customer-shaking-hands.jpg" alt="login image"> 
